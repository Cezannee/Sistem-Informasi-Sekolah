...
<div class="container py-3">
    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-md-6 col-xl-3">
            <a href="<?php echo e(route('students.index')); ?>" class="dash-card dash-card--click">
                <div class="dash-card__top">
                    ...
                    <div class="dash-card__meta">
                        ...
                        <div class="dash-value js-count" data-count="<?php echo e($stats['students'] ?? 0); ?>">0</div>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6 col-xl-3">
            <a href="<?php echo e(route('teachers.index')); ?>" class="dash-card dash-card--click">
                <div class="dash-card__top">
                    ...
                    <div class="dash-card__meta">
                        ...
                        <div class="dash-value js-count" data-count="<?php echo e($stats['teachers'] ?? 0); ?>">0</div>
                    </div>
                </div>
                <div class="dash-card__bottom">
        ...
        <div class="col-12 col-md-6 col-xl-3">
            <a href="<?php echo e(route('classes.index')); ?>" class="dash-card dash-card--click">
                <div class="dash-card__top">
                    ...
                    <div class="dash-card__meta">
                        ...
                        <div class="dash-value js-count" data-count="<?php echo e($stats['classes'] ?? 0); ?>">0</div>
                    </div>
                </div>
                <div class="dash-card__bottom">
        ...
        <div class="col-12 col-md-6 col-xl-3">
            <a href="<?php echo e(route('subjects.index')); ?>" class="dash-card dash-card--click">
                <div class="dash-card__top">
                    ...
                    <div class="dash-card__meta">
                        ...
                        <div class="dash-value js-count" data-count="<?php echo e($stats['subjects'] ?? 0); ?>">0</div>
                    </div>
                </div>
                <div class="dash-card__bottom">
            ...
            <div class="dash-panel">
                ...
                <div class="row g-2">
                    <div class="col-12 col-md-6">
                        <a class="dash-action" href="<?php echo e(route('students.create')); ?>">
                    ...
                    <div class="col-12 col-md-6">
                        <a class="dash-action" href="<?php echo e(route('teachers.create')); ?>">
                            <div class="dash-action__icon">+</div>
                            <div class="dash-action__text">
                    ...
                    <div class="col-12 col-md-6">
                        <a class="dash-action" href="<?php echo e(route('classes.create')); ?>">
                            <div class="dash-action__icon">+</div>
                            <div class="dash-action__text">
                    ...
                    <div class="col-12 col-md-6">
                        <a class="dash-action" href="<?php echo e(route('grades.create')); ?>">
                            <div class="dash-action__icon">+</div>
                            <div class="dash-action__text">
            ...
            <div class="dash-panel">
                ...
                <div class="dash-mini">
                    <div class="dash-mini__row">
                        ...
                        <div class="dash-mini__value js-count" data-count="<?php echo e($stats['grades'] ?? 0); ?>">0</div>
                    </div>
                    <a href="<?php echo e(route('grades.index')); ?>" class="btn btn-dark w-100 mt-2">
                        Lihat Nilai
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\Kuliah\Semester 5\Sistem Informasi Manajemen\sim-sekolah\sim-sekolah\resources\views/dashboard/index.blade.php ENDPATH**/ ?>