...
<div class="container">
    <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(route('teachers.create')); ?>" class="btn btn-primary">Tambah Guru</a>
    </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="fw-semibold"><?php echo e($t->nip); ?></td>
                                <td><?php echo e($t->name); ?></td>
                                <td><?php echo e($t->email ?? '-'); ?></td>
                                <td><?php echo e($t->phone ?? '-'); ?></td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e(route('teachers.edit', $t)); ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
                                        <form action="<?php echo e(route('teachers.destroy', $t)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH Z:\Kuliah\Semester 5\Sistem Informasi Manajemen\sim-sekolah\sim-sekolah\resources\views/teachers/index.blade.php ENDPATH**/ ?>